...
(function () {
  ...
  (function ($) {
    var q = function () {
      var r
      try {
        r = enderRequire('qwery')
      } catch (ex) {
        r = enderRequire('qwery-mobile')
      } finally {
        return r
      }
    }()
...
(function () {
  ...
  /*!
    ...
    */
  !function (name, definition) {
    if (typeof defineDoesntExist == 'function') defineDoesntExist(definition)
